...
class ShopPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView( // Use SingleChildScrollView for scrollable content
      padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 0), // Adjust vertical padding as needed
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  margin: const EdgeInsets.symmetric(horizontal: 4), // Small margin between pages
                  decoration: BoxDecoration(
                  ...
                  child: Text(
                    ...
                    style: const TextStyle(
                      ...
                      color: Colors.white, // Text color for visibility on banners
                      shadows: [
                        Shadow( // Simple text shadow for better readability
                          blurRadius: 3.0,
          ...
          const Padding(
            padding: EdgeInsets.symmetric(horizontal: 0.0), // No horizontal padding here as it's for the section title
            child: Text(
              'Top Categories',
              style: TextStyle(
                fontSize: 18,
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector( // Make categories tappable
                  onTap: () {
                    ...
                    child: Column(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          child: Icon(category['icon'] as IconData, color: Colors.blue.shade700, size: 30),
                        ),
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              final deals = [
                {'name': 'Smartwatch Pro', 'price': '\$99', 'oldPrice': '\$149', 'discount': '33% Off', 'image': 'https://placehold.co/100x100/FFDDC1/FF6F00?text=Deal+1'},
                {'name': 'Wireless Earbuds X', 'price': '\$49', 'oldPrice': '\$79', 'discount': '37% Off', 'image': 'https://placehold.co/100x100/FFDDC1/FF6F00?text=Deal+2'},
                {'name': 'Gaming Mouse RGB', 'price': '\$35', 'oldPrice': '\$50', 'discount': '30% Off', 'image': 'https://placehold.co/100x100/FFDDC1/FF6F00?text=Deal+3'},
                {'name': 'Portable Speaker Mini', 'price': '\$60', 'oldPrice': '\$85', 'discount': '29% Off', 'image': 'https://placehold.co/100x100/FFDDC1/FF6F00?text=Deal+4'},
              ];
                        ...
                        Center(
                          child: Image.network(
                            ...
                            errorBuilder: (context, error, stackTrace) => Container(
                              width: 96, height: 96, color: Colors.grey[300],
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: const TextStyle(
                                fontSize: 12,
                                color: Colors.grey,
                                decoration: TextDecoration.lineThrough, // Strikethrough old price
                              ),
                            ),
                          ],
                        ),
      ...
      child: Column(
        ...
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: const [
              Text('• Item 1: Quantity 5', style: TextStyle(fontSize: 16, color: Colors.grey)),
              Text('• Item 2: Quantity 12', style: TextStyle(fontSize: 16, color: Colors.grey)),
              Text('• Item 3: Out of Stock', style: TextStyle(fontSize: 16, color: Colors.grey)),
            ],
          ),
        ],
      ),
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: Colors.blue.shade200), // border border-blue-200
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: Colors.green.shade200), // border border-green-200
              borderRadius: BorderRadius.circular(8), // rounded-lg
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10), // px-4 py-2
            ),
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: Colors.purple.shade200), // border border-purple-200
              borderRadius: BorderRadius.circular(8), // rounded-lg
            ),
            margin: const EdgeInsets.only(bottom: 16),
            child: Column(
...
class _CustomHomePageState extends State<CustomHomePage> {
          ...
          children: [
                ...
                children: [
                        ...
                        child: Column(
                          ...
                          children: const [
                            Text(
                              'Sledje_Mobile',
                              style: TextStyle(
                                fontSize: 24, // Decreased from 28 to 24
                                fontWeight: FontWeight.bold,
                                color: Colors.white,
                              ),
                            ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _buildTopNavItem(context, 1, 'Support', Icons.support_agent),
                      _buildTopNavItem(context, 2, 'Services', Icons.business_center),
            ...
            Expanded(
              child: Transform.translate(
                ...
                child: Container(
                  // Removed the problematic 'margin' property from here
                  padding: const EdgeInsets.all(16),
                  decoration: const BoxDecoration(
                    color: Colors.white,
  ...
  Widget _buildTopNavItem(BuildContext context, int index, String label, IconData icon) {
